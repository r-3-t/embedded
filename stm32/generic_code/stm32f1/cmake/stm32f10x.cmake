...
macro (add_hal_files hal_implemented hal_type)
	...
	elseif (${${hal_implemented}} STREQUAL "")
		...
		#file (WRITE ${CMAKE_BINARY_DIR}/hal/${hal_filename} "// WARNING : DO NOT EDIT THIS FILE !!!!!!!!!!!\n")
		#file (APPEND ${CMAKE_BINARY_DIR}/hal/${hal_filename} "// it was genereated by CMAKE\n")
		#file (APPEND ${CMAKE_BINARY_DIR}/hal/${hal_filename} "// if you want to modify the content, edit the file : ${HAL_IMPLEMENTED_NATIVE_PATH}\n\n")
		#file (WRITE ${CMAKE_BINARY_DIR}/hal/${hal_filename} ${FILE_CONTENT})

		configure_file(${HAL_IMPLEMENTED_NATIVE_PATH} ${CMAKE_BINARY_DIR}/hal/${hal_filename} COPYONLY)

		#message ("copy : ${HAL_IMPLEMENTED_NATIVE_PATH} to ./hal/${hal_filename}")
		#message ("append : ${HAL_NATIVE_PATH}")
