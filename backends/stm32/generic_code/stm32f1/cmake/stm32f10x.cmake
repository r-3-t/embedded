...
if (NOT _RAM_SIZE)
	message (FATAL_ERROR "_RAM_SIZE must be defined")
endif()
if (NOT _FLASH_SIZE)
	message (FATAL_ERROR "_FLASH_SIZE must be defined")
endif()
if (NOT _MIN_STACK_SIZE)
	message (FATAL_ERROR "_MIN_STACK_SIZE must be defined")
endif()
