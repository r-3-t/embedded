#include <hal_stm32f4_uart.hpp>
#include <hal_stm32f4_spi.hpp>
#include <hal_stm32f4_gpio.hpp>
...
void SD_LowLevel_Init(void)
{
	...
	SPI_Cmd(SD_SPI, ENABLE); // enable SPI1
}
...
int main(void)
{
	...
	uart::Uart& uart = uart::get_instance(CURRENT_UART);


	//spi::init_instance(1);
	//spi::Spi& spi = spi::get_instance(1);

	//stm32f4::gpio::Stm32f4_PinOut cable_select(GPIOE, GPIO_Pin_7);
